...
(function (global) {
  const STR = {
    ua: {
      ...
      pathMetaTf: 'plan / state',
      pathMetaK8s: 'pods / deploy',
      pathMetaProd: 'SLO / on-call',
      continueTitle: 'Після Gym · куди далі',
      continueLede: 'Коли закриєш маршрут (~місяць): публічна практика й docs. Без злитих тестів роботодавців.',
      continueKindPractice: 'практика',
      continueKindDocs: 'docs',
      continueKindRead: 'читати',
      continueKindCross: 'міст',
    ...
    en: {
      ...
      pathMetaK8s: 'pods / deploy',
      pathMetaProd: 'SLO / on-call',
      continueTitle: 'After Gym · what next',
      continueLede: 'When the path is done (~a month): public practice and docs. No leaked employer tests.',
      continueKindPractice: 'practice',
      continueKindDocs: 'docs',
      continueKindRead: 'read',
      continueKindCross: 'bridge',
