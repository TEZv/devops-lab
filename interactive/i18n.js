...
(function (global) {
  const STR = {
    ua: {
      ...
      headerLede: 'Сходинка навичок · shell · Git/CI · Docker · Terraform. Пара з DE Mage Gym — той самий ritual, інший герой.',
    ...
    en: {
      pageTitle: 'DevOps Lab · Archer Gym',
      headerTitle: '🏹 DevOps Lab · Archer Gym',
      headerLede: 'Skill staircase · shell · Git/CI · Docker · Terraform. Sibling of DE Mage Gym — same ritual, different hero.',
      navDeLab: 'DE Mage Gym',
      navOpsMd: 'Ops Quest · MD',
      navMentorship: 'Mentorship',
      navRepo: 'Repo',
